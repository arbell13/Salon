...
<head>
  ...
  <title>LASHES AND HAIR SALON!</title>
...
<body>
  ...
  <header id="header" class="fixed-top  header-transparent ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html">Lashes and Hair Salon</a></h1>
  ...
  <main id="main">
    ...
    <section id="gallery" class="gallery">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>About us</h2>
          <p>Founded in 2015, Lush Lashes & Hair Salon by Abie Viceo is a boutique beauty establishment located in Caingin, San Rafael, Bulacan.<br>Our team of professional stylists are passionate about making our clients look and feel their best by providing top-notch hair and lash services.
          ...
          <div class="col-lg-6">
            <div class="row">
              <div class="col-lg-6 info">
                <i class="bx bx-map"></i>
                <h4>Address</h4>
                <p>Caingin San Rafael Bulacan </p>
              </div>
              <div class="col-lg-6 info">
